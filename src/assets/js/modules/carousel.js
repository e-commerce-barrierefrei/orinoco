...
var myCarousel = (function() {
    ...
    function init(set) {
        ...
        ctrls.innerHTML = '<li>' +
            '<button type="button" class="btn-prev"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="svg-triangle" width="24" height="24"><polygon points="0,12 24,0 24,24"/>            </svg></button></li>' +
            '<li>' +
            '<button type="button" class="btn-next"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="svg-triangle" width="24" height="24"><polygon points="24,12 0,24 0,0"/></svg></button>' +
            '</li>';
